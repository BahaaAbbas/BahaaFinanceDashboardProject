...
/**
 * StockJournal Component
 * - Allows users to log stock transactions and view a summary.
 * - Provides a transaction history table and calculates net profit/loss in real-time.
...
const StockJournal = () => {
   ...
   * @param {string} id - Transaction ID to be deleted.
   */
  ...
  /**
   * Calculates net profit or loss based on transactions.
